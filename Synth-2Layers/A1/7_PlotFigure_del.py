...
model_GS = np.load('results/model_2Lay_A1.npy')
model_GS_Q = np.load('results/model_2Lay_A1_Q.npy')
model_GS_IP = np.load('results/model_2Lay_A1_IP.npy')

# Models estimated with gradient descent
model_opt = np.load('results/model_2Lay_A1_Opt.npy')
model_opt_Q = np.load('results/model_2Lay_A1_Opt_Q.npy')
model_opt_IP = np.load('results/model_2Lay_A1_Opt_IP.npy')
                        
# Models estimated with global search, data with added noise
model_GS_n2 = np.load('results/model_2Lay_A1_GS_n2.npy')
model_GS_n5 = np.load('results/model_2Lay_A1_GS_n5.npy')
model_GS_n10 = np.load('results/model_2Lay_A1_GS_n10.npy')

# Models estimated with gradient descent, data with added noise
model_opt_n2 = np.load('results/model_2Lay_A1_Opt_n2.npy')
model_opt_n5 = np.load('results/model_2Lay_A1_Opt_n5.npy')
model_opt_n10 = np.load('results/model_2Lay_A1_Opt_n10.npy')
...
clb_err.ax.set_yticklabels([ r"$1\,\%$",
                         r"$10\,\%$", r"$100\,\%$"])
plt.savefig('figures/2Lay_LowCond_GSvsOpt.eps', format='eps')
...
plt.savefig('figures/2Lay_LowCond_GSvsOpt_noise.eps', format='eps')

#%%
# RMSE table 3 case A.1

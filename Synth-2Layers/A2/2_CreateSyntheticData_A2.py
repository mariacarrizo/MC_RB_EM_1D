...
sig_ini_A1_1 = [200/1000, 20/1000] # conductivities of the layers in S/m
sig_ini_A1_2 = [400/1000, 20/1000]
sig_ini_A1_3 = [800/1000, 20/1000]
sig_ini_A1_4 = [1600/1000, 20/1000]
...
np.save('data/data_synth_2Lay_A2_1', data_A1_1)
np.save('data/data_synth_2Lay_A2_2', data_A1_2)
np.save('data/data_synth_2Lay_A2_3', data_A1_3)
np.save('data/data_synth_2Lay_A2_4', data_A1_4)

np.save('models/model_synth_2Lay_A2_1', model_A1_1)
np.save('models/model_synth_2Lay_A2_2', model_A1_2)
np.save('models/model_synth_2Lay_A2_3', model_A1_3)
np.save('models/model_synth_2Lay_A2_4', model_A1_4)
...
np.save('data/data_GN_n2_A2_1', data_GN_n2_A2_1)
np.save('data/data_GN_n2_A2_2', data_GN_n2_A2_2)
np.save('data/data_GN_n2_A2_3', data_GN_n2_A2_3)
np.save('data/data_GN_n2_A2_4', data_GN_n2_A2_4)

np.save('data/data_GN_n5_A2_1', data_GN_n5_A2_1)
np.save('data/data_GN_n5_A2_2', data_GN_n5_A2_2)
np.save('data/data_GN_n5_A2_3', data_GN_n5_A2_3)
np.save('data/data_GN_n5_A2_4', data_GN_n5_A2_4)

np.save('data/data_GN_n10_A2_1', data_GN_n10_A2_1)
np.save('data/data_GN_n10_A2_2', data_GN_n10_A2_2)
np.save('data/data_GN_n10_A2_3', data_GN_n10_A2_3)
np.save('data/data_GN_n10_A2_4', data_GN_n10_A2_4)

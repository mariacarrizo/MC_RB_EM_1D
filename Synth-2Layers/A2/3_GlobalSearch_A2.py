# Script to perform global search inversion for case A.2
...
np.save('results/model_2Lay_A2_GS', model_GS)
np.save('results/model_2Lay_A2_GS_Q', model_GS_Q)
np.save('results/model_2Lay_A2_GS_IP', model_GS_IP)

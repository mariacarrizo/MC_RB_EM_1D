...
from EM1D import EMf_2Lay_HP_field
...
height = 0.20 # meters height from ground surface to center of coils
...
np.save('data/survey_texel.npy', survey)
...
np.save('data/LUTable_2Lay_Texel', LUT)

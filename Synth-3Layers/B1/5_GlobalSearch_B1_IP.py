...
# -*- coding: utf-8 -*-
""" 
Script Name: 5_GlobalSearch_B1_IP.py
Description: Script to perform Global Search in B1 cases using only In-Phase
Author: @mariacarrizo
...
model_B1_1 = Parallel(n_jobs=n_workers,verbose=0)(delayed(GlobalSearch_3Lay)(LUT[:,9:], data_B1_1[pos,9:],
...
model_B1_2 = Parallel(n_jobs=n_workers,verbose=0)(delayed(GlobalSearch_3Lay)(LUT[:,9:], data_B1_2[pos,9:],
                      conds, thicks) for pos in range(npos))
...
model_B1_3 = Parallel(n_jobs=n_workers,verbose=0)(delayed(GlobalSearch_3Lay)(LUT[:,9:], data_B1_3[pos,9:],
                      conds, thicks) for pos in range(npos))
...
model_B1_4 = Parallel(n_jobs=n_workers,verbose=0)(delayed(GlobalSearch_3Lay)(LUT[:,9:], data_B1_4[pos,9:],
                      conds, thicks) for pos in range(npos))
...
np.save('results/model_GS_IP_B1_1', model_B1_1)
np.save('results/model_GS_IP_B1_2', model_B1_2)
np.save('results/model_GS_IP_B1_3', model_B1_3)
np.save('results/model_GS_IP_B1_4', model_B1_4)

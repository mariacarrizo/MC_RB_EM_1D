...
# -*- coding: utf-8 -*-
""" 
Script Name: 10_GaussNewton_Noise_B1.py
...
model_GN_n2_B1_1 = np.zeros_like(model_B1_1)
...
for pos in range(npos):
    ...
    model_GN_n2_B1_1[pos] = model_GN_pos
print('End')
...
model_GN_n2_B1_2 = np.zeros_like(model_B1_2)
...
for pos in range(npos):
    ...
    model_GN_pos = invEM.run(dataE, relativeError, startModel= m0, lam=lam, verbose=False)
    model_GN_n2_B1_2[pos] = model_GN_pos
print('End')
...
model_GN_n2_B1_3 = np.zeros_like(model_B1_3)
...
for pos in range(npos):
    ...
    model_GN_pos = invEM.run(dataE, relativeError, startModel= m0, lam=lam, verbose=False)
    model_GN_n2_B1_3[pos] = model_GN_pos
print('End')
...
model_GN_n2_B1_4 = np.zeros_like(model_B1_4)
...
for pos in range(npos):
    ...
    model_GN_pos = invEM.run(dataE, relativeError, startModel= m0, lam=lam, verbose=False)
    model_GN_n2_B1_4[pos] = model_GN_pos
print('End')
...
model_GN_n5_B1_1 = np.zeros_like(model_B1_1)
...
for pos in range(npos):
    ...
    model_GN_pos = invEM.run(dataE, relativeError, startModel= m0, lam=lam, verbose=False)
    model_GN_n5_B1_1[pos] = model_GN_pos
print('End')
...
model_GN_n5_B1_2 = np.zeros_like(model_B1_2)
...
for pos in range(npos):
    ...
    model_GN_pos = invEM.run(dataE, relativeError, startModel= m0, lam=lam, verbose=False)
    model_GN_n5_B1_2[pos] = model_GN_pos
print('End')
...
model_GN_n5_B1_3 = np.zeros_like(model_B1_3)
...
for pos in range(npos):
    ...
    model_GN_pos = invEM.run(dataE, relativeError, startModel= m0, lam=lam, verbose=False)
    model_GN_n5_B1_3[pos] = model_GN_pos
print('End')
...
model_GN_n5_B1_4 = np.zeros_like(model_B1_4)
...
for pos in range(npos):
    ...
    model_GN_pos = invEM.run(dataE, relativeError, startModel= m0, lam=lam, verbose=False)
    model_GN_n5_B1_4[pos] = model_GN_pos
print('End')
...
model_GN_n10_B1_1 = np.zeros_like(model_B1_1)
...
for pos in range(npos):
    ...
    model_GN_pos = invEM.run(dataE, relativeError, startModel= m0, lam=lam, verbose=False)
    model_GN_n10_B1_1[pos] = model_GN_pos
print('End')
...
model_GN_n10_B1_2 = np.zeros_like(model_B1_2)
...
for pos in range(npos):
    ...
    model_GN_pos = invEM.run(dataE, relativeError, startModel= m0, lam=lam, verbose=False)
    model_GN_n10_B1_2[pos] = model_GN_pos
print('End')
...
model_GN_n10_B1_3 = np.zeros_like(model_B1_3)
...
for pos in range(npos):
    ...
    model_GN_pos = invEM.run(dataE, relativeError, startModel= m0, lam=lam, verbose=False)
    model_GN_n10_B1_3[pos] = model_GN_pos
print('End')
...
model_GN_n10_B1_4 = np.zeros_like(model_B1_4)
...
for pos in range(npos):
    ...
    model_GN_pos = invEM.run(dataE, relativeError, startModel= m0, lam=lam, verbose=False)
    model_GN_n10_B1_4[pos] = model_GN_pos
print('End')

# Store estimated models
np.save('results/model_GN_n2_B1_1', model_GN_n2_B1_1)
np.save('results/model_GN_n2_B1_2', model_GN_n2_B1_2)
np.save('results/model_GN_n2_B1_3', model_GN_n2_B1_3)
np.save('results/model_GN_n2_B1_4', model_GN_n2_B1_4)

np.save('results/model_GN_n5_B1_1', model_GN_n5_B1_1)
np.save('results/model_GN_n5_B1_2', model_GN_n5_B1_2)
np.save('results/model_GN_n5_B1_3', model_GN_n5_B1_3)
np.save('results/model_GN_n5_B1_4', model_GN_n5_B1_4)

np.save('results/model_GN_n10_B1_1', model_GN_n10_B1_1)
np.save('results/model_GN_n10_B1_2', model_GN_n10_B1_2)
np.save('results/model_GN_n10_B1_3', model_GN_n10_B1_3)
np.save('results/model_GN_n10_B1_4', model_GN_n10_B1_4)
...
model_Opt_n2_B2_1 = np.load('results/model_Opt_n2_B2_1.npy')
model_Opt_n2_B2_2 = np.load('results/model_Opt_n2_B2_2.npy')
model_Opt_n2_B2_3 = np.load('results/model_Opt_n2_B2_3.npy')
model_Opt_n2_B2_4 = np.load('results/model_Opt_n2_B2_4.npy')

model_Opt_n5_B2_1 = np.load('results/model_Opt_n5_B2_1.npy')
model_Opt_n5_B2_2 = np.load('results/model_Opt_n5_B2_2.npy')
model_Opt_n5_B2_3 = np.load('results/model_Opt_n5_B2_3.npy')
model_Opt_n5_B2_4 = np.load('results/model_Opt_n5_B2_4.npy')

model_Opt_n10_B2_1 = np.load('results/model_Opt_n10_B2_1.npy')
model_Opt_n10_B2_2 = np.load('results/model_Opt_n10_B2_2.npy')
model_Opt_n10_B2_3 = np.load('results/model_Opt_n10_B2_3.npy')
model_Opt_n10_B2_4 = np.load('results/model_Opt_n10_B2_4.npy')
...
# Simulate data in each position
for i in range(npos):
    data_Opt_n2_B2_1.append(EMf_3Lay_HVP(lambd, 
                                     sigma1 = model_Opt_n2_B2_1[i,2], 
                                     sigma2 = model_Opt_n2_B2_1[i,3], 
                                     sigma3 = model_Opt_n2_B2_1[i,4],
                                     h1 = model_Opt_n2_B2_1[i,0], 
                                     h2 = model_Opt_n2_B2_1[i,1], 
                                     height = height,
                                     offsets = offsets,
                                     freq = freq,
                                     filt = filt)) 
    data_Opt_n2_B2_2.append(EMf_3Lay_HVP(lambd, 
                                     sigma1 = model_Opt_n2_B2_2[i,2], 
                                     sigma2 = model_Opt_n2_B2_2[i,3], 
                                     sigma3 = model_Opt_n2_B2_2[i,4],
                                     h1 = model_Opt_n2_B2_2[i,0], 
                                     h2 = model_Opt_n2_B2_2[i,1], 
                                     height = height,
                                     offsets = offsets,
                                     freq = freq,
                                     filt = filt)) 
    data_Opt_n2_B2_3.append(EMf_3Lay_HVP(lambd, 
                                     sigma1 = model_Opt_n2_B2_3[i,2], 
                                     sigma2 = model_Opt_n2_B2_3[i,3], 
                                     sigma3 = model_Opt_n2_B2_3[i,4],
                                     h1 = model_Opt_n2_B2_3[i,0], 
                                     h2 = model_Opt_n2_B2_3[i,1], 
                                     height = height,
                                     offsets = offsets,
                                     freq = freq,
                                     filt = filt)) 
    data_Opt_n2_B2_4.append(EMf_3Lay_HVP(lambd, 
                                     sigma1 = model_Opt_n2_B2_4[i,2], 
                                     sigma2 = model_Opt_n2_B2_4[i,3], 
                                     sigma3 = model_Opt_n2_B2_4[i,4],
                                     h1 = model_Opt_n2_B2_4[i,0], 
                                     h2 = model_Opt_n2_B2_4[i,1], 
                                     height = height,
                                     offsets = offsets,
                                     freq = freq,
                                     filt = filt)) 
...
for i in range(npos):
    data_Opt_n5_B2_1.append(EMf_3Lay_HVP(lambd, 
                                     sigma1 = model_Opt_n5_B2_1[i,2], 
                                     sigma2 = model_Opt_n5_B2_1[i,3], 
                                     sigma3 = model_Opt_n5_B2_1[i,4],
                                     h1 = model_Opt_n5_B2_1[i,0], 
                                     h2 = model_Opt_n5_B2_1[i,1], 
                                     height = height,
                                     offsets = offsets,
                                     freq = freq,
                                     filt = filt)) 
    data_Opt_n5_B2_2.append(EMf_3Lay_HVP(lambd, 
                                     sigma1 = model_Opt_n5_B2_2[i,2], 
                                     sigma2 = model_Opt_n5_B2_2[i,3], 
                                     sigma3 = model_Opt_n5_B2_2[i,4],
                                     h1 = model_Opt_n5_B2_2[i,0], 
                                     h2 = model_Opt_n5_B2_2[i,1], 
                                     height = height,
                                     offsets = offsets,
                                     freq = freq,
                                     filt = filt)) 
    data_Opt_n5_B2_3.append(EMf_3Lay_HVP(lambd, 
                                     sigma1 = model_Opt_n5_B2_3[i,2], 
                                     sigma2 = model_Opt_n5_B2_3[i,3], 
                                     sigma3 = model_Opt_n5_B2_3[i,4],
                                     h1 = model_Opt_n5_B2_3[i,0], 
                                     h2 = model_Opt_n5_B2_3[i,1], 
                                     height = height,
                                     offsets = offsets,
                                     freq = freq,
                                     filt = filt)) 
    data_Opt_n5_B2_4.append(EMf_3Lay_HVP(lambd, 
                                     sigma1 = model_Opt_n5_B2_4[i,2], 
                                     sigma2 = model_Opt_n5_B2_4[i,3], 
                                     sigma3 = model_Opt_n5_B2_4[i,4],
                                     h1 = model_Opt_n5_B2_4[i,0], 
                                     h2 = model_Opt_n5_B2_4[i,1], 
                                     height = height,
                                     offsets = offsets,
                                     freq = freq,
                                     filt = filt)) 
...
for i in range(npos):
    data_Opt_n10_B2_1.append(EMf_3Lay_HVP(lambd, 
                                     sigma1 = model_Opt_n10_B2_1[i,2], 
                                     sigma2 = model_Opt_n10_B2_1[i,3], 
                                     sigma3 = model_Opt_n10_B2_1[i,4],
                                     h1 = model_Opt_n10_B2_1[i,0], 
                                     h2 = model_Opt_n10_B2_1[i,1], 
                                     height = height,
                                     offsets = offsets,
                                     freq = freq,
                                     filt = filt)) 
    data_Opt_n10_B2_2.append(EMf_3Lay_HVP(lambd, 
                                     sigma1 = model_Opt_n10_B2_2[i,2], 
                                     sigma2 = model_Opt_n10_B2_2[i,3], 
                                     sigma3 = model_Opt_n10_B2_2[i,4],
                                     h1 = model_Opt_n10_B2_2[i,0], 
                                     h2 = model_Opt_n10_B2_2[i,1], 
                                     height = height,
                                     offsets = offsets,
                                     freq = freq,
                                     filt = filt)) 
    data_Opt_n10_B2_3.append(EMf_3Lay_HVP(lambd, 
                                     sigma1 = model_Opt_n10_B2_3[i,2], 
                                     sigma2 = model_Opt_n10_B2_3[i,3], 
                                     sigma3 = model_Opt_n10_B2_3[i,4],
                                     h1 = model_Opt_n10_B2_3[i,0], 
                                     h2 = model_Opt_n10_B2_3[i,1],  
                                     height = height,
                                     offsets = offsets,
                                     freq = freq,
                                     filt = filt)) 
    data_Opt_n10_B2_4.append(EMf_3Lay_HVP(lambd, 
                                     sigma1 = model_Opt_n10_B2_4[i,2], 
                                     sigma2 = model_Opt_n10_B2_4[i,3], 
                                     sigma3 = model_Opt_n10_B2_4[i,4],
                                     h1 = model_Opt_n10_B2_4[i,0], 
                                     h2 = model_Opt_n10_B2_4[i,1], 
                                     height = height,
                                     offsets = offsets,
                                     freq = freq,
                                     filt = filt)) 
...
np.save('data/data_Opt_n2_B2_1', data_Opt_n2_B2_1)
np.save('data/data_Opt_n2_B2_2', data_Opt_n2_B2_2)
np.save('data/data_Opt_n2_B2_3', data_Opt_n2_B2_3)
np.save('data/data_Opt_n2_B2_4', data_Opt_n2_B2_4)

np.save('data/data_Opt_n5_B2_1', data_Opt_n5_B2_1)
np.save('data/data_Opt_n5_B2_2', data_Opt_n5_B2_2)
np.save('data/data_Opt_n5_B2_3', data_Opt_n5_B2_3)
np.save('data/data_Opt_n5_B2_4', data_Opt_n5_B2_4)

np.save('data/data_Opt_n10_B2_1', data_Opt_n10_B2_1)
np.save('data/data_Opt_n10_B2_2', data_Opt_n10_B2_2)
np.save('data/data_Opt_n10_B2_3', data_Opt_n10_B2_3)
np.save('data/data_Opt_n10_B2_4', data_Opt_n10_B2_4)
